...
const STAGES = [
  ...
  },
  {
    ...
    theme: "huawei",
    companyGroup: { zh: "华为公司经历 · 1 / 2", en: "Huawei experience · 1 / 2" },
    accent: "#cf0a2c",
    secondary: "#ff6b6b",
    phase: { zh: "华为公司 · 无线产品线", en: "Huawei · Wireless Product Line" },
    logo: "assets/brand/huawei-professional.svg",
    logoAlt: "Huawei",
    title: { zh: "华为无线产品线 · 基带芯片设计验证", en: "Huawei Wireless · Baseband Chip Verification" },
    summary: {
      zh: "在华为无线产品线，从 FPGA 原型验证扩展到 Scheduler 子系统验证与团队负责工作。",
      en: "Within Huawei's Wireless Product Line, progressed from FPGA prototyping to scheduler-subsystem verification and team leadership.",
    },
  ...
  },
  {
    ...
    accent: "#cf0a2c",
    secondary: "#f2a900",
    phase: { zh: "华为公司 · 计算产品线", en: "Huawei · Computing Product Line" },
    logo: "assets/brand/huawei-professional.svg",
    logoAlt: "Huawei",
    title: { zh: "华为计算产品线 · 昇腾芯片验证与平台工程", en: "Huawei Computing · Ascend Chip Verification and Platform Engineering" },
    summary: {
      zh: "随后在同一家公司转入计算产品线，负责昇腾 NPU 组网、流片前验证方法、原型验证团队建设与验证平台工程。",
      en: "Later moved within Huawei to the Computing Product Line, responsible for Ascend NPU networking, pre-silicon validation methodology, prototyping-team development, and verification platform engineering.",
    },
